...
public partial class UnityPlugin
{
    ...
    /// </summary>
    private async Task UpdateContactsCacheOptimistically(Guid contactId, CreateContactRequest contactRequest, ProfileContext profileContext, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            await _cacheInvalidationService.InvalidateProfileDataCacheAsync(profileContext.ProfileId, PluginId, profileContext.Provider, "CONTACTS");
    ...
    private async Task InvalidateContactsCache(Guid profileId, string provider, CancellationToken cancellationToken)
    {
        ...
        try
        {
            await _cacheInvalidationService.InvalidateProfileDataCacheAsync(profileId, PluginId, provider, "CONTACTS");
