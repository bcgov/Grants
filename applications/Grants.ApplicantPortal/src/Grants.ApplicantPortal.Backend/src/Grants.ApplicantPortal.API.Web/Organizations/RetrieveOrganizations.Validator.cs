...
/// <summary>
/// Validator for RetrieveOrganizationsRequest
/// </summary>
public class RetrieveOrganizationsValidator : Validator<RetrieveOrganizationsRequest>
{
  public RetrieveOrganizationsValidator()
  {
