...
/// <summary>
/// Validator for HydrateProfileRequest (HydrateProfile endpoint)
/// See: https://fast-endpoints.com/docs/validation
/// </summary>
public class HydrateProfileValidator : Validator<HydrateProfileRequest>
{
    public HydrateProfileValidator()
    {
