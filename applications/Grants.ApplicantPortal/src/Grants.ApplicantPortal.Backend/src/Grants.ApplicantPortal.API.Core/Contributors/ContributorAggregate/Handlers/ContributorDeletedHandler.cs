using Grants.ApplicantPortal.API.Core.Contributors.ContributorAggregate.Events;
using Grants.ApplicantPortal.API.Core.Email;

namespace Grants.ApplicantPortal.API.Core.Contributors.ContributorAggregate.Handlers;
